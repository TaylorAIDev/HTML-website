(function (window, document, Math) {
    ...
    function createDefaultScrollbar(direction, interactive, type) {
        ...
        return type === !0 && (scrollbar.style.cssText = "position:absolute;z-index:9999",
            ...
            direction == "h" ? (type === !0 && (scrollbar.style.cssText += ";height:7px;left:2px;right:2px;bottom:0",
                indicator.style.height = "100%"),
                scrollbar.className = "iScrollHorizontalScrollbar") : (type === !0 && (scrollbar.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px",
    ...
    function Indicator(scroller, options) {
        ...
        this.sizeRatioX = 1,
            ...
            this.maxPosX = 0,
            this.maxPosY = 0,
            this.options.interactive && (this.options.disableTouch || (utils.addEvent(this.indicator, "touchstart", this),
                utils.addEvent(window, "touchend", this)),
                this.options.disablePointer || (utils.addEvent(this.indicator, utils.prefixPointerEvent("pointerdown"), this),
                    utils.addEvent(window, utils.prefixPointerEvent("pointerup"), this)),
                this.options.disableMouse || (utils.addEvent(this.indicator, "mousedown", this),
        ...
        if (this.options.fade) {
            ...
            utils.isBadAndroid && rAF(function () {
                self.wrapperStyle[durationProp] === "0.0001ms" && (self.wrapperStyle[durationProp] = "0s")
            }),
        ...
        , utils = function () {
            ...
            me.getTime = Date.now || function getTime() {
                ...
                me.momentum = function (current, start, time, lowerMargin, wrapperSize, deceleration) {
                    ...
                    return deceleration = deceleration === undefined ? 6e-4 : deceleration,
                        destination = current + speed * speed / (2 * deceleration) * (distance < 0 ? -1 : 1),
                        duration = speed / deceleration,
                        destination < lowerMargin ? (destination = wrapperSize ? lowerMargin - wrapperSize / 2.5 * (speed / 8) : lowerMargin,
                            distance = Math.abs(destination - current),
                            duration = distance / speed) : destination > 0 && (destination = wrapperSize ? wrapperSize / 2.5 * (speed / 8) : 0,
            ...
            return me.extend(me, {
                ...
                me.isBadAndroid = function () {
                    ...
                    if (/Android/.test(appVersion) && !/Chrome\/\d/.test(appVersion)) {
                        ...
                        return safariVersion && typeof safariVersion == "object" && safariVersion.length >= 2 ? parseFloat(safariVersion[1]) < 535.19 : !0
                    }
                    return !1
                }(),
                me.extend(me.style = {}, {
                ...
                me.extend(me.ease = {}, {
                    ...
                    elastic: {
                        ...
                        fn: function (k) {
                            var f = .22
                                , e = .4;
                            return k === 0 ? 0 : k == 1 ? 1 : e * Math.pow(2, -10 * k) * Math.sin((k - f / 4) * 2 * Math.PI / f) + 1
                        }
                    }
                }),
                ...
                me.click = function (e) {
                    ...
                    /(SELECT|INPUT|TEXTAREA)/i.test(target.tagName) || (ev = document.createEvent(window.MouseEvent ? "MouseEvents" : "Event"),
                        ev.initEvent("click", !0, !0),
    ...
    IScroll.prototype = {
        ...
        _start: function (e) {
            if (utils.eventType[e.type] != 1) {
                var button;
                e.which ? button = e.button : button = e.button < 2 ? 0 : e.button == 4 ? 1 : 2;
                if (button !== 0)
                    return
            }
        ...
        _move: function (e) {
            ...
            if (timestamp - this.endTime > 300 && absDistX < 10 && absDistY < 10)
                return;
            !this.directionLocked && !this.options.freeScroll && (absDistX > absDistY + this.options.directionLockThreshold ? this.directionLocked = "h" : absDistY >= absDistX + this.options.directionLockThreshold ? this.directionLocked = "v" : this.directionLocked = "n");
            ...
            this.directionX = deltaX > 0 ? -1 : deltaX < 0 ? 1 : 0,
                ...
                timestamp - this.startTime > 300 && (this.startTime = timestamp,
                    this.startX = this.x,
                    this.startY = this.y)
        },
        _end: function (e) {
            ...
            if (!this.moved) {
                this.options.tap && utils.tap(e, this.options.tap),
            ...
            this.options.momentum && duration < 300 && (momentumX = this.hasHorizontalScroll ? utils.momentum(this.x, this.startX, duration, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                destination: newX,
                duration: 0
            },
        ...
        scrollTo: function (x, y, time, easing) {
            ...
            !time || transitionType ? (transitionType && (this._transitionTimingFunction(easing.style),
                this._transitionTime(time)),
                this._translate(x, y)) : this._animate(x, y, time, easing.fn)
        },
        scrollToElement: function (el, time, offsetX, offsetY, easing) {
            ...
            pos.left -= this.wrapperOffset.left,
                ...
                offsetX === !0 && (offsetX = Math.round(el.offsetWidth / 2 - this.wrapper.offsetWidth / 2)),
        ...
        _transitionTime: function (time) {
            ...
            if (!time && utils.isBadAndroid) {
                ...
                var self = this;
                rAF(function () {
                    self.scrollerStyle[durationProp] === "0.0001ms" && (self.scrollerStyle[durationProp] = "0s")
                })
            }
            if (this.indicators)
        ...
        _translate: function (x, y) {
            if ((" " + this.wrapper.className + " ").replace(/[\n\t]/g, " ").indexOf(" no-scrolloverflow ") > -1)
                return !1;
            this.options.useTransform ? this.scrollerStyle[utils.style.transform] = "translate(" + x + "px," + y + "px)" + this.translateZ : (x = Math.round(x),
                y = Math.round(y),
        ...
        _initEvents: function (remove) {
            ...
            eventType(window, "orientationchange", this),
                ...
                this.options.disableMouse || (eventType(this.wrapper, "mousedown", this),
                ...
                utils.hasTouch && !this.options.disableTouch && (eventType(this.wrapper, "touchstart", this),
        ...
        getComputedPosition: function () {
            ...
            return this.options.useTransform ? (matrix = matrix[utils.style.transform].split(")")[0].split(", "),
                ...
                y = +(matrix[13] || matrix[5])) : (x = +matrix.left.replace(/[^-\d.]/g, ""),
        ...
        _initIndicators: function () {
            ...
            var interactive = this.options.interactiveScrollbars, customStyle = typeof this.options.scrollbars != "string", indicators = [], indicator, that = this;
            this.indicators = [],
                this.options.scrollbars && (this.options.scrollY && (indicator = {
        ...
        _wheel: function (e) {
            ...
            this.wheelTimeout === undefined && that._execEvent("scrollStart"),
                clearTimeout(this.wheelTimeout),
            ...
            if ("deltaX" in e)
                e.deltaMode === 1 ? (wheelDeltaX = -e.deltaX * this.options.mouseWheelSpeed,
            ...
            wheelDeltaX *= this.options.invertWheelDirection,
                ...
                this.hasVerticalScroll || (wheelDeltaX = wheelDeltaY,
                    wheelDeltaY = 0);
            if (this.options.snap) {
                newX = this.currentPage.pageX,
                    newY = this.currentPage.pageY,
                    wheelDeltaX > 0 ? newX-- : wheelDeltaX < 0 && newX++,
                    wheelDeltaY > 0 ? newY-- : wheelDeltaY < 0 && newY++,
        ...
        _nearestSnap: function (x, y) {
            ...
            x > 0 ? x = 0 : x < this.maxScrollX && (x = this.maxScrollX),
                y > 0 ? y = 0 : y < this.maxScrollY && (y = this.maxScrollY);
            for (; i < l; i++)
            ...
            return i == this.currentPage.pageX && (i += this.directionX,
                ...
                x = this.pages[i][0].x),
                m == this.currentPage.pageY && (m += this.directionY,
                    m < 0 ? m = 0 : m >= this.pages[0].length && (m = this.pages[0].length - 1),
                    y = this.pages[0][m].y),
            {
                x: x,
                y: y,
        ...
        goToPage: function (x, y, time, easing) {
            easing = easing || this.options.bounceEasing,
                x >= this.pages.length ? x = this.pages.length - 1 : x < 0 && (x = 0),
                y >= this.pages[x].length ? y = this.pages[x].length - 1 : y < 0 && (y = 0);
        ...
        next: function (time, easing) {
            ...
            x++,
                x >= this.pages.length && this.hasVerticalScroll && (x = 0,
                    y++),
        ...
        prev: function (time, easing) {
            var x = this.currentPage.pageX
                , y = this.currentPage.pageY;
            x--,
                x < 0 && this.hasVerticalScroll && (x = 0,
                    y--),
                this.goToPage(x, y, time, easing)
        },
        _initKeys: function (e) {
            ...
            if (typeof this.options.keyBindings == "object")
                for (i in this.options.keyBindings)
                    typeof this.options.keyBindings[i] == "string" && (this.options.keyBindings[i] = this.options.keyBindings[i].toUpperCase().charCodeAt(0));
            else
        ...
        _key: function (e) {
            ...
            this.options.useTransition && this.isInTransition && (pos = this.getComputedPosition(),
                this._translate(Math.round(pos.x), Math.round(pos.y)),
                this.isInTransition = !1),
            ...
            newX > 0 ? (newX = 0,
                this.keyAcceleration = 0) : newX < this.maxScrollX && (newX = this.maxScrollX,
                    this.keyAcceleration = 0),
                newY > 0 ? (newY = 0,
                    this.keyAcceleration = 0) : newY < this.maxScrollY && (newY = this.maxScrollY,
                        this.keyAcceleration = 0),
                this.scrollTo(newX, newY, 0),
                this.keyTime = now
        },
        ...
        Indicator.prototype = {
            ...
            transitionTime: function (time) {
                ...
                if (!time && utils.isBadAndroid) {
                    ...
                    var self = this;
                    rAF(function () {
                        self.indicatorStyle[durationProp] === "0.0001ms" && (self.indicatorStyle[durationProp] = "0s")
                    })
                }
            },
            ...
            refresh: function () {
                this.transitionTime(),
                    ...
                    this.scroller.hasHorizontalScroll && this.scroller.hasVerticalScroll ? (utils.addClass(this.wrapper, "iScrollBothScrollbars"),
                        ...
                        this.options.defaultScrollbars && this.options.customStyle && (this.options.listenX ? this.wrapper.style.right = "8px" : this.wrapper.style.bottom = "8px")) : (utils.removeClass(this.wrapper, "iScrollBothScrollbars"),
            ...
            updatePosition: function () {
                ...
                this.options.ignoreBoundaries || (x < this.minBoundaryX ? (this.options.shrink == "scale" && (this.width = Math.max(this.indicatorWidth + x, 8),
                    this.indicatorStyle.width = this.width + "px"),
                    x = this.minBoundaryX) : x > this.maxBoundaryX ? this.options.shrink == "scale" ? (this.width = Math.max(this.indicatorWidth - (x - this.maxPosX), 8),
                        this.indicatorStyle.width = this.width + "px",
                        x = this.maxPosX + this.indicatorWidth - this.width) : x = this.maxBoundaryX : this.options.shrink == "scale" && this.width != this.indicatorWidth && (this.width = this.indicatorWidth,
                            this.indicatorStyle.width = this.width + "px"),
                    y < this.minBoundaryY ? (this.options.shrink == "scale" && (this.height = Math.max(this.indicatorHeight + y * 3, 8),
                        this.indicatorStyle.height = this.height + "px"),
                        y = this.minBoundaryY) : y > this.maxBoundaryY ? this.options.shrink == "scale" ? (this.height = Math.max(this.indicatorHeight - (y - this.maxPosY) * 3, 8),
                            this.indicatorStyle.height = this.height + "px",
                            y = this.maxPosY + this.indicatorHeight - this.height) : y = this.maxBoundaryY : this.options.shrink == "scale" && this.height != this.indicatorHeight && (this.height = this.indicatorHeight,
                                this.indicatorStyle.height = this.height + "px")),
                    this.x = x,
                    this.y = y,
                    this.scroller.options.useTransform ? this.indicatorStyle[utils.style.transform] = "translate(" + x + "px," + y + "px)" + this.scroller.translateZ : (this.indicatorStyle.left = x + "px",
        ...
        IScroll.utils = utils,
        typeof module != "undefined" && module.exports ? module.exports = IScroll : typeof define == "function" && define.amd ? define(function () {
            return IScroll
    ...
    function (global, factory) {
        ...
        }) : typeof exports == "object" && exports ? module.exports = factory(require("jquery"), global, global.document, global.Math) : factory(jQuery, global, global.document, global.Math)
        ...
        var WRAPPER = "fullpage-wrapper"
            ...
            , AUTO_HEIGHT_SEL = ".fp-auto-height"
            , NORMAL_SCROLL = "fp-normal-scroll"
            , NORMAL_SCROLL_SEL = ".fp-normal-scroll"
            , SECTION_NAV = "fp-nav"
        ...
        $.fn.fullpage = function (options) {
            function setAutoScrolling(value, type) {
                ...
                options.autoScrolling && !options.scrollBar ? ($htmlBody.css({
                    ...
                    element.length && silentScroll(element.position().top)) : ($htmlBody.css({
                        ...
                        element.length && $htmlBody.scrollTop(element.position().top))
            }
            ...
            function setMouseWheelScrolling(value) {
                value ? (addMouseWheelHandler(),
                    addMiddleWheelHandler()) : (removeMouseWheelHandler(),
                        removeMiddleWheelHandler())
            }
            function setAllowScrolling(value, directions) {
                typeof directions != "undefined" ? (directions = directions.replace(/ /g, "").split(","),
                    $.each(directions, function (index, direction) {
                        setIsScrollAllowed(value, direction, "m")
                    })) : value ? (setMouseWheelScrolling(!0),
                        addTouchHandler()) : (setMouseWheelScrolling(!1),
                            removeTouchHandler())
            }
            ...
            function moveSectionUp() {
                ...
                !prev.length && (options.loopTop || options.continuousVertical) && (prev = $(SECTION_SEL).last()),
                    prev.length && scrollPage(prev, null, !0)
            }
            function moveSectionDown() {
                var next = $(SECTION_ACTIVE_SEL).next(SECTION_SEL);
                !next.length && (options.loopBottom || options.continuousVertical) && (next = $(SECTION_SEL).first()),
                    next.length && scrollPage(next, null, !1)
            }
            ...
            function moveTo(sectionAnchor, slideAnchor) {
                ...
                typeof slideAnchor != "undefined" ? scrollPageAndSlide(sectionAnchor, slideAnchor) : destiny.length > 0 && scrollPage(destiny)
            }
            ...
            function reBuild(resizing) {
                ...
                isResizing = !0,
                    ...
                    $(SECTION_SEL).each(function () {
                        ...
                        options.verticalCentered && $(this).find(TABLE_CELL_SEL).css("height", getTableHeight($(this)) + "px"),
                            $(this).css("height", windowsHeight + "px"),
                            options.scrollOverflow && (slides.length ? slides.each(function () {
                                createScrollBar($(this))
                            }) : createScrollBar($(this))),
                            slides.length > 1 && landscapeScroll(slidesWrap, slidesWrap.find(SLIDE_ACTIVE_SEL))
                    });
            ...
            function setResponsive(active) {
                ...
                active ? isResponsive || (setAutoScrolling(!1, "internal"),
                    setFitToSection(!1, "internal"),
                    $(SECTION_NAV_SEL).hide(),
                    $body.addClass(RESPONSIVE),
                    $.isFunction(options.afterResponsive) && options.afterResponsive.call(container, active)) : isResponsive && (setAutoScrolling(originals.autoScrolling, "internal"),
            ...
            function init() {
                options.css3 && (options.css3 = support3d()),
            ...
            function bindEvents() {
                $window.on("hashchange", hashChangeHandler).blur(blurHandler).resize(resizeHandler),
            ...
            function setOptionsFromDOM() {
                ...
                options.anchors.length || (options.anchors = sections.filter("[data-anchor]").map(function () {
                    ...
                    options.navigationTooltips.length || (options.navigationTooltips = sections.filter("[data-tooltip]").map(function () {
                ...
                container.css({
                    ...
                    $(SECTION_SEL).each(function (index) {
                        ...
                        styleSection(section, index),
                            ...
                            numSlides > 0 ? styleSlides(section, slides, numSlides) : options.verticalCentered && addTableClass(section)
                    }),
                    options.fixedElements && options.css3 && $(options.fixedElements).appendTo($body),
                    options.navigation && addVerticalNavigation(),
                    enableYoutubeAPI(),
                    options.scrollOverflow ? (document.readyState === "complete" && createScrollBarHandler(),
                        $window.on("load", createScrollBarHandler)) : afterRenderActions()
            }

            function styleSection(section, index) {
                !index && $(SECTION_ACTIVE_SEL).length === 0 && section.addClass(ACTIVE),
                    startingSection = $(SECTION_ACTIVE_SEL),
                    section.css("height", windowsHeight + "px"),
                    options.paddingTop && section.css("padding-top", options.paddingTop),
                    options.paddingBottom && section.css("padding-bottom", options.paddingBottom),
                    typeof options.sectionsColor[index] != "undefined" && section.css("background-color", options.sectionsColor[index]),
                    typeof options.anchors[index] != "undefined" && section.attr("data-anchor", options.anchors[index])
            }
            function styleMenu(section, index) {
                typeof options.anchors[index] != "undefined" && section.hasClass(ACTIVE) && activateMenuAndNav(options.anchors[index], index),
                    options.menu && options.css3 && $(options.menu).closest(WRAPPER_SEL).length && $(options.menu).appendTo($body)
            }
            ...
            function afterRenderActions() {
                ...
                section.addClass(COMPLETELY),
                    options.scrollOverflowHandler.afterRender && options.scrollOverflowHandler.afterRender(section),
                    lazyLoad(section),
                    playMedia(section),
                    options.scrollOverflowHandler.afterLoad(),
                    isDestinyTheStartingSection() && $.isFunction(options.afterLoad) && options.afterLoad.call(section, section.data("anchor"), section.index(SECTION_SEL) + 1),
                    $.isFunction(options.afterRender) && options.afterRender.call(container, getTableHeight())
            }
            function isDestinyTheStartingSection() {
                var anchors = window.location.hash.replace("#", "").split("/")
                    , destinationSection = getSectionByAnchor(decodeURIComponent(anchors[0]));
            ...
            function scrollHandler() {
                ...
                if (!options.autoScrolling || options.scrollBar) {
                    ...
                    isCompletelyInViewPort(scrollDirection) && ($(SECTION_ACTIVE_SEL).hasClass(COMPLETELY) || $(SECTION_ACTIVE_SEL).addClass(COMPLETELY).siblings().removeClass(COMPLETELY)),
                        currentSection = $(sections).eq(visibleSectionIndex);
                    if (!currentSection.hasClass(ACTIVE)) {
                        isScrolling = !0;
                        var leavingSection = $(SECTION_ACTIVE_SEL), leavingSectionIndex = leavingSection.index(SECTION_SEL) + 1, yMovement = getYmovement(currentSection), anchorLink = currentSection.data("anchor"), sectionIndex = currentSection.index(SECTION_SEL) + 1, activeSlide = currentSection.find(SLIDE_ACTIVE_SEL), slideIndex, slideAnchorLink;
                        activeSlide.length && (slideAnchorLink = activeSlide.data("anchor"),
                            slideIndex = activeSlide.index()),
                            canScroll && (currentSection.addClass(ACTIVE).siblings().removeClass(ACTIVE),
                                ...
                                options.anchors.length && (lastScrolledDestiny = anchorLink),
                    ...
                    options.fitToSection && (clearTimeout(scrollId2),
                        scrollId2 = setTimeout(function () {
                            options.fitToSection && fitToSection()
                        }, options.fitToSectionDelay))
                }
            }
            function fitToSection() {
                canScroll && (isResizing = !0,
            ...
            function MouseWheelHandler(e) {
                ...
                if (options.autoScrolling && !controlPressed && !isNormalScroll) {
                    ...
                    scrollings.length > 149 && scrollings.shift(),
                        ...
                        options.scrollBar && (e.preventDefault ? e.preventDefault() : e.returnValue = !1);
                    var activeSection = $(SECTION_ACTIVE_SEL)
            ...
            function getDestinationPosition(element) {
                ...
                !$masthead.hasClass("menu-transparent") && $("body").hasClass("uncode-fp-menu-shrink") && !element.is(":first-child") && (position += 18);
                ...
                return previousDestTop = position,
                    position
            }
            function scrollPage(element, callback, isMovementUp) {
                if (typeof element == "undefined")
                    return;
                var dtop = getDestinationPosition(element), slideAnchorLink, slideIndex, v = {
                    element: element,
                    callback: callback,
                ...
                if (v.activeSection.is(element) && !isResizing || options.scrollBar && $window.scrollTop() === v.dtop && !element.hasClass(AUTO_HEIGHT))
                    return;
                v.activeSlide.length && (slideAnchorLink = v.activeSlide.data("anchor"),
                    slideIndex = v.activeSlide.index()),
                    options.autoScrolling && options.continuousVertical && typeof v.isMovementUp != "undefined" && (!v.isMovementUp && v.yMovement == "up" || v.isMovementUp && v.yMovement == "down") && (v = createInfiniteSections(v));
                if ($.isFunction(options.onLeave) && !v.localIsResizing && options.onLeave.call(v.activeSection, v.leavingSection, v.sectionIndex + 1, v.yMovement) === !1)
                    return;
                v.localIsResizing || stopMedia(v.activeSection),
            ...
            function performMovement(v) {
                if (options.css3 && options.autoScrolling && !options.scrollBar) {
                    ...
                    transformContainer(translate3d, !0),
                        options.scrollingSpeed ? (clearTimeout(afterSectionLoadsId),
            ...
            function createInfiniteSections(v) {
                return v.isMovementUp ? $(SECTION_ACTIVE_SEL).before(v.activeSection.nextAll(SECTION_SEL)) : $(SECTION_ACTIVE_SEL).after(v.activeSection.prevAll(SECTION_SEL).get().reverse()),
            ...
            function continuousVerticalFixSectionOrder(v) {
                if (!v.wrapAroundElements || !v.wrapAroundElements.length)
                    return;
                v.isMovementUp ? $(SECTION_FIRST_SEL).before(v.wrapAroundElements) : $(SECTION_LAST_SEL).after(v.wrapAroundElements),
                    silentScroll($(SECTION_ACTIVE_SEL).position().top),
                    keepSlidesPosition()
            }
            ...
            function lazyLoad(destiny) {
                if (!options.lazyLoading)
                    return;
                var panel = getSlideOrSection(destiny), element;
                panel.find("img[data-src], img[data-srcset], source[data-src], audio[data-src], iframe[data-src]").each(function () {
                    element = $(this),
                        $.each(["src", "srcset"], function (index, type) {
                            var attribute = element.attr("data-" + type);
                            typeof attribute != "undefined" && attribute && setSrc(element, type)
                        }),
                        element.is("source") && element.closest("video").get(0).load()
                })
            }
            function playMedia(destiny) {
                ...
                panel.find("video, audio").each(function () {
                    ...
                    element.hasAttribute("data-autoplay") && typeof element.play == "function" && element.play()
                }),
            ...
            function addAnimation(container, element) {
                ...
                return container.removeClass(NO_TRANSITION),
                    container.css({
            ...
            function activateNavDots(name, sectionIndex) {
                options.navigation && ($(SECTION_NAV_SEL).find(ACTIVE_SEL).removeClass(ACTIVE),
                    name ? $(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addClass(ACTIVE) : $(SECTION_NAV_SEL).find("li").eq(sectionIndex).find("a").addClass(ACTIVE))
            }
            function activateMenuElement(name) {
                options.menu && ($(options.menu).find(ACTIVE_SEL).removeClass(ACTIVE),
            ...
            function setState(slideIndex, slideAnchor, anchorLink, sectionIndex) {
                var sectionHash = "";
                options.anchors.length && !options.lockAnchors && (slideIndex ? (typeof anchorLink != "undefined" && (sectionHash = anchorLink),
                    typeof slideAnchor == "undefined" && (slideAnchor = slideIndex),
                    lastScrolledSlide = slideAnchor,
                    setUrlHash(sectionHash + "/" + slideAnchor)) : typeof slideIndex != "undefined" ? (lastScrolledSlide = slideAnchor,
                        setUrlHash(anchorLink)) : setUrlHash(anchorLink)),
                    setBodyClass()
            }
            ...
            function getAnchor(element) {
                var anchor = element.data("anchor")
                    , index = element.index();
                return typeof anchor == "undefined" && (anchor = index),
                    anchor
            }
            function setBodyClass() {
                ...
                slide.length && (text = text + "-" + slideAnchor),
            ...
            function support3d() {
                ...
                for (var t in transforms)
                    el.style[t] !== undefined && (el.style[t] = "translate3d(1px,1px,1px)",
            ...
            displayWarnings(),
                ...
                $(this).length && (FP.setAutoScrolling = setAutoScrolling,
            ...
            ,
            typeof IScroll != "undefined" && (IScroll.prototype.wheelOn = function () {
        ...
        var iscrollHandler = {
            ...
            toggleWheel: function (value) {
                ...
                scrollable.each(function () {
                    ...
                    typeof iScrollInstance != "undefined" && iScrollInstance && (value ? iScrollInstance.wheelOn() : iScrollInstance.wheelOff())
                })
            },
            onLeave: function () {
